...
// Parse FormData items that is the items in the invoice [{description, qty, unitPrice}]
...
export const getInvoiceById = async (req, res) => {
    try {
        ...
        if (inv.owner && invoice.owner !== userId) {
...
export const updateInvoice = async (req, res) => {
    try {
        ...
        //ensure that it doesnt already exists in the database
        if (
            body.invoiceNumber &&
        ...
        // we can update these fields now
        const update = {
