            ...
            <div className={featuresStyles.container}>
                <div className={featuresStyles.headerContainer}>
                    ...
                    <p className={featuresStyles.subtitle}>
                        A minimal, intelligent interface that focuses on what
                        truly matters – create, send , and track invoices
                        effortlessly while maintaining professional excellence.
                    </p>
                </div>
