...
const Appshell = () => {
    ...
    const displayName = (() => {
        if (!user) return "User";
        // IIFE is used hence displayName is not a function but a variable
        ...
        >
            {({ isActive }) => (
                <>
                    ...
                    {!collapsed && isActive && (
                        <div
                            className={appShellStyles.sidebarActiveIndicator}
                        />
                    )}
                </>
            )}
                        ...
                        <div>
                            <div
                                className={`${appShellStyles.logoContainer} ${
                                    collapsed
                                        ? appShellStyles.logoContainerCollapsed
                                        : ""
                                }`}
                            >
                                <Link
                                ...
                                >
                                    ...
                                    {!collapsed && (
                                        <div
                                            className={
                                                appShellStyles.logoTextContainer
                                            }
                                        >
                                            <span
                                                className={
                                                    appShellStyles.logoText
                                                }
                                            >
                                                InvoiceAI
                                            </span>
                                ...
                                <div className={appShellStyles.collapseSection}>
                                    <button
                                        ...
                                        className={`${appShellStyles.collapseButtonInner} ${
                                            collapsed
                                                ? appShellStyles.collapseButtonCollapsed
                                                : ""
                                        }`}
                                    >
                                        {!collapsed && (
                        ...
                        <div className={appShellStyles.mobileSidebar}>
                            <div className={appShellStyles.mobileHeader}>
                                ...
                                >
                                    <img
                                        ...
                                        alt="logo"
                                        className={
                                            appShellStyles.mobileLogoImage
                                        }
                                    />
                                    <span
                                        className={
                                            appShellStyles.mobileLogoText
                                        }
                                    >
                                        InvoiceAI
                                    </span>
                                ...
                                >
                                    <svg
                                        className={
                                            appShellStyles.mobileCloseIcon
                                        }
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        stroke="currentColor"
                            ...
                            <div className={appShellStyles.mobileLogoutSection}>
                                <button
                                    ...
                                    className={
                                        appShellStyles.mobileLogoutButton
                                    }
                                >
                                    <LogoutIcon /> Logout
                                </button>
                            ...
                            <div className={appShellStyles.headerContent}>
                                ...
                                {!isMobile && (
                                    <button
                                        onClick={toggleSidebar}
                                        className={
                                            appShellStyles.desktopCollapseButton
                                        }
                                    >
                                        <CollapseIcon collapsed={collapsed} />
                                    </button>
