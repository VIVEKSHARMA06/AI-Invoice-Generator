...
export default function CreateInvoice() {
    ...
    const obtainToken = useCallback(async () => {
        ...
        try {
            let token = await getToken({ template: "default" }).catch(
                () => null,
            );
            if (!token) {
                token = await getToken({ forceRefresh: true }).catch(
                    () => null,
                );
            }
            return token;
    ...
    function updateClient(field, value) {
        setInvoice((inv) =>
            inv
                ? { ...inv, client: { ...(inv.client || {}), [field]: value } }
                : inv,
        );
    }
    ...
    const checkInvoiceExists = useCallback(
        async (candidate) => {
            ...
            if (local.some((x) => x && x.invoiceNumber === candidate))
                return true;
            ...
            try {
                ...
                setInvoice((prev) => {
                    ...
                    const merged = {
                        ...
                        signatureName:
                            prev.signatureName ||
                            serverProfile.signatureOwnerName ||
                            "",
                        signatureTitle:
                            prev.signatureTitle ||
                            serverProfile.signatureOwnerTitle ||
                            "",
                        taxPercent:
                            prev &&
                            prev.taxPercent !== undefined &&
                            prev.taxPercent !== null
                                ? prev.taxPercent
    ...
    useEffect(() => {
        ...
        async function prepare() {
            ...
            if (invoiceFromState) {
                ...
                base.logoDataUrl =
                    resolveImageUrl(
                        base.logoDataUrl ?? base.logoUrl ?? base.logo,
                    ) || null;
                base.stampDataUrl =
                    resolveImageUrl(
                        base.stampDataUrl ?? base.stampUrl ?? base.stamp,
                    ) || null;
            ...
            if (isEditing && !invoiceFromState) {
                    ...
                    if (res.ok) {
                        ...
                        if (data && mounted) {
                            ...
                            merged.invoiceNumber =
                                data.invoiceNumber ?? merged.invoiceNumber;
                ...
                const found = all.find(
                    (x) =>
                        x &&
                        (x.id === id || x._id === id || x.invoiceNumber === id),
                );
                if (found && mounted) {
                    ...
                    fixed.logoDataUrl =
                        resolveImageUrl(
                            found.logoDataUrl ?? found.logoUrl ?? found.logo,
                        ) ||
                        fixed.logoDataUrl ||
                        null;
                    fixed.stampDataUrl =
    ...
    async function handleSave() {
        ...
        try {
            ...
            if (
                ...
                alert(
                    err.message ||
                        "Invoice number already exists. Choose another.",
                );
                setLoading(false);
                return;
            }
        ...
        <div className={createInvoiceStyles.pageContainer}>
            ...
            <div className={createInvoiceStyles.cardContainer}>
                <div className={createInvoiceStyles.cardHeaderContainer}>
                    ...
                    <h2 className={createInvoiceStyles.cardTitle}>
                        Invoice Details
                    </h2>
                </div>
                    ...
                    <div>
                        ...
                        <div className={createInvoiceStyles.currencyContainer}>
                            ...
                            >
                                <span
                                    className={
                                        createInvoiceCustomStyles.currencySymbol
                                    }
                                >
                                    ₹
                                </span>
            ...
            <div className={createInvoiceStyles.mainGrid}>
                <div className={createInvoiceStyles.leftColumn}>
                    ...
                    <div className={createInvoiceStyles.cardContainer}>
                        <div
                            className={createInvoiceStyles.cardHeaderWithButton}
                        >
                    ...
                    <div className={createInvoiceStyles.cardContainer}>
                        <div
                            className={createInvoiceStyles.cardHeaderContainer}
                        >
                            <div
                    ...
                    <div className={createInvoiceStyles.cardContainer}>
                        ...
                        >
                            <div className={createInvoiceStyles.cardHeaderLeft}>
                                <div
                                    className={
                                        createInvoiceStyles.cardIconContainer
                                    }
                                >
                                    <svg
                                        className="w-5 h-5"
                            ...
                            {items.map((it, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div
                                            className={
                                                createInvoiceStyles.itemColDescription
                                            }
                                        >
                                            <label
                                                className={
                                                    createInvoiceStyles.itemsFieldLabel
                                                }
                                                htmlFor={`desc-${idx}`}
                                            >
                                                Description
                                            ...
                                            <input
                                                id={`desc-${idx}`}
                                                className={
                                                    createInvoiceStyles.itemsInput
                                                }
                                        ...
                                        <div
                                            className={
                                                createInvoiceStyles.itemColQuantity
                                            }
                                        >
                                            <label
                                                className={
                                            ...
                                            <input
                                                ...
                                                pattern="[0-9]*"
                                                className={
                                                    createInvoiceStyles.itemsNumberInput
                                                }
                                                value={String(it?.qty ?? "")}
                                                onChange={(e) =>
                                                    updateItem(
                                        ...
                                        <div
                                            className={
                                                createInvoiceStyles.itemColUnitPrice
                                            }
                                        >
                                            <label
                                                className={
                                        ...
                                        <div
                                            className={
                                                createInvoiceStyles.itemColTotal
                                            }
                                        >
                                            <label
                                                className={
                                            ...
                                            <div
                                                className={
                                                    createInvoiceStyles.itemsTotal
                                                }
                                                title={totalLabel}
                                        ...
                                        <div
                                            className={
                                                createInvoiceStyles.itemColRemove
                                            }
                                        >
                                            <button
                                                type="button"
                                                ...
                                                className={
                                                    createInvoiceStyles.itemsRemoveButton
                                                }
                    ...
                    <div className={createInvoiceStyles.cardSmallContainer}>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div
                                    className={
                                        createInvoiceStyles.uploadSmallArea
                                    }
                                >
                                    {invoice?.logoDataUrl ? (
                                        <div
                                            className={
                                                createInvoiceStyles.imagePreviewContainer
                                            }
                                        >
                                            <div
                                                className={
                                                    createInvoiceStyles.logoPreview
                                                }
                                            >
                                                <img
                                            ...
                                            <div
                                                className={
                                                    createInvoiceStyles.buttonGroup
                                                }
                                            >
                                                <label
                                                    className={
                                                        createInvoiceStyles.changeButton
                                                    }
                                                >
                                                ...
                                                <button
                                                    ...
                                                    className={
                                                        createInvoiceStyles.removeButton
                                                    }
                                                >
                                                    <DeleteIcon className="w-4 h-4" />{" "}
                                                    Remove
                                        ...
                                        <label className="cursor-pointer block">
                                            ...
                                            >
                                                <div
                                                    className={
                                                        createInvoiceStyles.uploadIconContainer
                                                    }
                                                >
                                                ...
                                                <div>
                                                    <p
                                                        className={
                                                            createInvoiceStyles.uploadTextTitle
                                                        }
                                                    >
                                                        Upload Logo
                                                    </p>
                                                    <p
                                                        className={
                                                            createInvoiceStyles.uploadTextSubtitle
                                                        }
                                                    >
                                                        PNG, JPG up to 5MB
                                                    </p>
                    ...
                    <div className={createInvoiceStyles.cardSmallContainer}>
                        ...
                        <div className="space-y-4">
                            <div className={createInvoiceStyles.summaryRow}>
                                <div
                                    className={createInvoiceStyles.summaryLabel}
                                >
                                    Subtotal
                                </div>
                                <div
                                    className={createInvoiceStyles.summaryValue}
                                >
                                    {currencyFmt(
                                        totals.subtotal,
                                        invoice.currency,
                            ...
                            <div className="space-y-3">
                                <div>
                                    <label
                                        className={createInvoiceStyles.label}
                                    >
                                        Tax Percentage
                                    </label>
                                    <input
                                        ...
                                        className={
                                            createInvoiceStyles.inputCenter
                                        }
                                        min="0"
                                        max="100"
                                        step="0.1"
                                ...
                                >
                                    {invoice.stampDataUrl ? (
                                        ...
                                        >
                                            <div
                                                className={
                                                    createInvoiceStyles.stampPreview
                                                }
                                            >
                                                <img
                                ...
                                >
                                    {invoice.signatureDataUrl ? (
                                        ...
                                        >
                                            <div
                                                className={
                                                    createInvoiceStyles.signaturePreview
                                                }
                                            >
                                                <img
                                                    src={
